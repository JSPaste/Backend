...
export const DocumentDataStruct = ($root.DocumentDataStruct = (() => {
  ...
  DocumentDataStruct.encode = function encode(message, writer) {
    ...
    if (
      message.rawFileData != null &&
      Object.hasOwnProperty.call(message, "rawFileData")
    )
    ...
    if (
      ...
      writer
        ...
        .uint64(message.expirationTimestamp);
    if (
  ...
  DocumentDataStruct.decode = function decode(reader, length) {
    ...
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.DocumentDataStruct();
  ...
  DocumentDataStruct.verify = function verify(message) {
    ...
    if (message.rawFileData != null && message.hasOwnProperty("rawFileData"))
      if (
        !(
          (message.rawFileData &&
            typeof message.rawFileData.length === "number") ||
          $util.isString(message.rawFileData)
        )
      )
        return "rawFileData: buffer expected";
    if (message.secret != null && message.hasOwnProperty("secret"))
      if (!$util.isString(message.secret)) return "secret: string expected";
    if (
      message.expirationTimestamp != null &&
  ...
  DocumentDataStruct.fromObject = function fromObject(object) {
    if (object instanceof $root.DocumentDataStruct) return object;
    let message = new $root.DocumentDataStruct();
    if (object.rawFileData != null)
      if (typeof object.rawFileData === "string")
        $util.base64.decode(
          object.rawFileData,
          (message.rawFileData = $util.newBuffer(
            $util.base64.length(object.rawFileData),
          )),
          0,
        );
  ...
  DocumentDataStruct.toObject = function toObject(message, options) {
    ...
    let object = {};
    if (options.defaults) {
      if (options.bytes === String) object.rawFileData = "";
      else {
        object.rawFileData = [];
      ...
      object.rawFileData =
        options.bytes === String
          ? $util.base64.encode(
              message.rawFileData,
              0,
              message.rawFileData.length,
            )
          : options.bytes === Array
            ? Array.prototype.slice.call(message.rawFileData)
            : message.rawFileData;
    if (message.secret != null && message.hasOwnProperty("secret"))
    ...
    if (message.password != null && message.hasOwnProperty("password")) {
      ...
      if (options.oneofs) object._password = "password";
    }
    return object;
  };
