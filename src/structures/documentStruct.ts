...
export interface DocumentDataStruct {
    ...
    secret: string;
    /**
     * @generated from protobuf field: optional int64 expire_timestamp = 3;
     */
...
class DocumentDataStruct$Type extends MessageType<DocumentDataStruct> {
    constructor() {
        super("DocumentDataStruct", [
            ...
            { no: 3, name: "expire_timestamp", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string secret */ 2:
                    ...
                    break;
                case /* optional int64 expire_timestamp */ 3:
                    message.expireTimestamp = reader.int64().toBigInt();
                    break;
    ...
    internalBinaryWrite(message: DocumentDataStruct, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional int64 expire_timestamp = 3; */
        if (message.expireTimestamp !== undefined)
            writer.tag(3, WireType.Varint).int64(message.expireTimestamp);
