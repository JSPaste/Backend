...
import { humanizeSize, humanizeTime } from "#util/humanize.mts";
import { type DocumentVersionType, documentVersionV1, documentVersionV2 } from "./document.mts";
...
export const env = arkenv(
  {
    ...
    JSPB_DOCUMENT_COMPRESSION: type.boolean
      .pipe((boolean): DocumentVersionType => (boolean ? documentVersionV1 : documentVersionV2))
      .default(true),
