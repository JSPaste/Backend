...
import { v1DocumentHandler } from "#endpoint/document/v1/index.mts";
import { v2LegacyDocumentHandler } from "#endpoint/legacy/v2/documents/index.mts";
import { v1UserHandler } from "#endpoint/user/v1/index.mts";
import { Logger } from "#util/console.mts";
import { env } from "../utils/env.mts";
import { errorCodeCrash, errorCodeDocumentCorrupted, errorGet } from "../utils/error.mts";
